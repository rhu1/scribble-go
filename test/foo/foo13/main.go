//rhu@HZHL4 ~/code/go
//$ go install github.com/rhu1/scribble-go-runtime/test/foo/foo13
//$ bin/foo13.exe
...
import (
	...
	"github.com/rhu1/scribble-go-runtime/test/foo/foo13/Foo13/Proto1"
	S "github.com/rhu1/scribble-go-runtime/test/foo/foo13/Foo13/Proto1/S_1to1"
	W1K "github.com/rhu1/scribble-go-runtime/test/foo/foo13/Foo13/Proto1/W_1toK"
...
func runW(w *W1K.Init) W1K.End {
	end := w.S_1_Gather_Foo()
	fmt.Println("W(" + strconv.Itoa(w.Ept.Self) + ") gathered:")
	return *end
}
