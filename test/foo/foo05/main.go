//rhu@HZHL4 ~/code/go
//$ go install github.com/rhu1/scribble-go-runtime/test/foo/foo5
//$ bin/foo5.exe
...
import (
	...
	"github.com/rhu1/scribble-go-runtime/test/foo/foo5/Foo5/Proto1"
...
func serverCode(wg *sync.WaitGroup, n int) *Proto1.Proto1_S_1To1_End {
	...
	for i := 0; i < 3; i++ {
		s1 = s1.Split_W_1Ton_a(1234, util.Copy)
	}
