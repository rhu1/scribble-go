//rhu@HZHL4 ~/code/go
//$ go install github.com/rhu1/scribble-go-runtime/test/foreach/foreach01
//$ bin/foreach01.exe
...
import (
	...
	S_1 "github.com/rhu1/scribble-go-runtime/test/foreach/foreach01/Foreach1/Proto1/S_1to1"
